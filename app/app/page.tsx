...
export default function Home() {
  return (
    <main className="flex-1  p-2 lg:p-5 bg-gradient-to-bl from-indigo-400 to-indigo-900">
      <div className="bg-white py-24 overflow-y-auto sm:py-32 rounded-md drop-shadow-xl">
